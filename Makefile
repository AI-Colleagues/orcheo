.PHONY: dev-server test lint format studio-lint studio-format studio-test redis worker celery-beat desktop-macos desktop-tauri-check desktop-tauri-dev desktop-tauri-build \
