...
- **Workflow Tabs Surface (Studio Frontend)**
  - Update tab triggers and tab content wiring to remove `Studio`/`execution` from active navigation and add `workflow`.
  - Files:
...
- **Workflow Mermaid Panel (Studio Frontend)**
  ...
  - Proposed files:
    - `apps/studio/src/features/workflow/pages/workflow/components/workflow-tab-content.tsx`
...
- **Legacy Editor/Execution Namespace**
  ...
  - Proposed structure:
    - `apps/studio/src/features/workflow/legacy/workflow/components/Studio-tab-content.tsx`
    - `apps/studio/src/features/workflow/legacy/workflow/components/execution-tab-content.tsx`
    - `apps/studio/src/features/workflow/legacy/workflow/components/workflow-layout.legacy.tsx` (optional snapshot)
...
2. Card click handler routes to `/workflow/{workflowId}`.
...
- **Integration tests**
  - `workflow` route defaults to Workflow tab and renders Mermaid state.
